...
public class Practical_5
{
    public static void main(String[] args) {
        ...
        AIML aiml = new AIML("Yatharth Walde", "Vedant Shende", "Peeyush Kaware", "Bhavesh More", "Samarth Sharma");
        AIDS aids = new AIDS("Yatharth Walde", "Vedant Shende", "Peeyush Kaware", "Bhavesh More", "Samarth Sharma");
        CSE cse = new CSE("Yatharth Walde", "Vedant Shende", "Peeyush Kaware", "Bhavesh More", "Samarth Sharma");
